...
@section('title', 'Register as a Non-Exhibitor - Masharket')
        ...
        <div class="max-w-3xl mx-auto px-6 lg:px-8">
            <div class="mb-10 text-center">
                <div class="inline-flex items-center gap-3 rounded-full border border-black/10 bg-[var(--brand-bg)] px-5 py-2.5 mb-6">
                    ...
                    <span class="text-[11px] md:text-xs tracking-[0.26em] uppercase text-gray-600 font-medium">Non-Exhibitor Registration</span>
                </div>
                <h1 class="text-3xl md:text-4xl font-medium text-[#111111]">Register as a Non-Exhibitor</h1>
            ...
            <form action="{{ route('market.non-exhibitors.store') }}" method="POST" class="space-y-10">
                @csrf
