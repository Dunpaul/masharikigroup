...
return [
    ...
    */
    ...
    |
    | Pinned to 'public' regardless of FILESYSTEM_DISK: every image-rendering
    | view and model in this app (GalleryImage, ImageColumn, partner/news/team
    | uploads) reads from the 'public' disk (storage/app/public, symlinked to
    | public/storage). Filament's own default follows FILESYSTEM_DISK, which
    | is 'local' (storage/app/private, not web-accessible) — that mismatch
    | was causing every admin-uploaded image to save somewhere the site
    | couldn't serve, rendering as a broken image.
    |
    */
