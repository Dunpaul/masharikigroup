...
namespace App\Filament\Resources\VirtualAttendants\Tables;
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('viewTicket')
                    ...
                    ->url(fn ($record) => route('market.ticket.show', ['type' => 'virtual_attendant', 'registrationId' => $record->registration_id]))
                    ->openUrlInNewTab()
