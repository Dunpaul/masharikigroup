...
namespace App\Filament\Resources\NonExhibitors\Tables;
        ...
        return $table
            ...
            ->recordActions([
                ...
                Action::make('viewTicket')
                    ...
                    ->url(fn ($record) => route('market.ticket.show', ['type' => 'non_exhibitor', 'registrationId' => $record->registration_id]))
                    ->openUrlInNewTab()
